---
description: 作業成果のHTMLレポート生成 — 直近のブラウザタスクの操作履歴・変更前後の比較・学びを1枚にまとめる。Use when ユーザーが「レポートにして」「今日の作業をまとめて」「成果を見せて」「報告書を作って」等、実施済みタスクの可視化・報告を求めたとき、またはタスク完了時に成果報告として提案するとき
