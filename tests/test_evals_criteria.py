...
CRITERIA = {
    ...
    "G37 engagement-reply-jp": ("skills/engagement-reply-jp/SKILL.md",
                                ["侮辱罪", "違法・有害情報相談センター", "返さない"]),
    "G38 engagement-reply-jp": ("skills/engagement-reply-jp/SKILL.md",
                                ["自社に都合の良い内容に改めるよう依頼", "客観的な事実に反する"]),
    "G39 winning-position-jp": ("skills/winning-position-jp/SKILL.md",
                               ["広告費が効きにくい場所", "非対称な強み", "捨てる"]),
    "G40 hypothesis-design-jp": ("skills/hypothesis-design-jp/SKILL.md",
                                ["反証可能", "観察", "1回で1つだけ変える"]),
    "G41 breakout-content-jp": ("skills/breakout-content-jp/SKILL.md",
                               ["2〜10%", "クリックベイト", "切り分ける"]),
    "G42 growth-challenger": ("agents/growth-challenger.md",
                             ["BOLD-ENOUGH", "削る提案", "非対称な強み"]),
