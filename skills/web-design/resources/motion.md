...
- `prefers-reduced-motion`（動きの低減）は CSS メディア特性として標準化されている。
  **本ファイルは仕様書・MDN を取得して確認していない**。対応状況や構文を断定で書く前に当たる

**【社内基準】**

- 「目的駆動でのみ動かす」という方針、使ってよい場面・禁止の分類、duration の既定値、納品時の確認項目
